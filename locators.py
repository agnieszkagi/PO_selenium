...
class RegisterPageLocators:
    ...
    MISSING_NAME = (
        By.XPATH,
        '//div[@class="_5v-0 _53im"]/div[contains(text(), "What’s your name?")]',
    )
    MISSING_SURNAME = (
        By.XPATH,
        '//div[@class="_5v-0 _53il"]/div[contains(text(), "What’s your name?")]',
    )
    WRONG_EMAIL = (
        By.XPATH,
        '//*[contains(text(), "Please enter a valid mobile number or email address.")]',
    )
    WRONG_PASSWORD = (
        By.XPATH,
        '//*[contains(text(), "Enter a combination of at least six numbers, letters and punctuation marks (like ! and &).")]',
    )
    WRONG_BIRTHDAY = (
        By.XPATH,
        '//*[contains(text(), "It looks like you entered the wrong info. Please be sure to use your real birthday.")]',
    )
    MISSING_GENDER = (
        By.XPATH,
        '//*[contains(text(), "Please choose a gender. You can change who can see this later.")]',
    )
